...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('-offline-2d-feat', type=str, required=True)  # temporary solution for offline 2D feat
    ...
    parser.add_argument('--feat2d', type=str, default="ROI", choices=['ROI', 'ROI3D', 'CLIP', 'CLIP3D', 'CLIP_add3D'], help="\
