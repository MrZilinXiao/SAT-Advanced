...
if __name__ == "__main__":
    ...
    xyz = Variable(torch.randn(2, 9, 3, device=torch.device('cuda')), requires_grad=True)
    xyz_feats = Variable(torch.randn(2, 9, 6, device=torch.device('cuda')), requires_grad=True)
