...
from data_generation.sr3d import ReferenceGenerator, Reference
from in_out import three_d_object
...
class BetweenGenerator(ReferenceGenerator):
    ...
    @staticmethod
    def valid_between_anchors(anchor_a: three_d_object.ThreeDObject, anchor_b: three_d_object.ThreeDObject) -> bool:
        """
